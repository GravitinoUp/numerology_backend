...
export class SeedRunicFormulasEn1716297170399 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.manager.insert(FormulaResult, [
      ...
      },
      {
        formula_type_id: FormulaTypesEnum.RUNIC_FORMULAS,
        result_keys: ['success'],
        result_name: 'Деньги, успех, процветание',
        result_content: '',
        result_image: '/files/uploads?path=uploads/images/runic-formulas/success.jpg',
        language_code: 'en',
      },
      {
        formula_type_id: FormulaTypesEnum.RUNIC_FORMULAS,
